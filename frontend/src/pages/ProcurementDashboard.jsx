                        ...
                        <tbody>
                          {(() => {
                            ...
                            if (poFilter === 'awaiting') {
                              return pos.filter(p => ['Approved', 'Sent', 'Confirmed', 'Partially Delivered'].includes(p.status));
                            } else if (poFilter === 'pending') {
                              return pos.filter(p => p.status === 'Pending');
                            } else if (poFilter === 'delivered') {
                              return pos.filter(p => p.status === 'Completed');
                            } else if (poFilter === 'drafts') {
                              return pos.filter(p => p.status === 'Draft' || p.status === 'Rejected');
                            }
                            return pos;
                          })().map(po => {
                                  ...
                                  <div style={{ display: 'flex', gap: '6px', justifyContent: 'flex-end' }}>
                                    {po.status === 'Draft' || po.status === 'Rejected' ? (
                                      ...
                                      <>
                                        ...
                                        {['Approved', 'Sent', 'Confirmed', 'Partially Delivered'].includes(po.status) ? (
                                          <button 
                                            className="proc-btn" 
                                            style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '6px 12px', fontSize: '12px', background: '#ECFDF5', color: '#047857', border: '1px solid #A7F3D0', borderRadius: '6px', fontWeight: 700 }}
                                            onClick={() => {
                                          ...
                                          >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg> View Details
                                          </button>
                                        )}
                                      </>
                                    )}
