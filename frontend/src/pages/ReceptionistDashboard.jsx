...
const ReceptionistDashboard = () => {
  ...
  const [hospitalClinicalServices, setHospitalClinicalServices] = useState([
    ...
    { serviceName: 'Dental ΓÇö Root Canal Treatment (RCT)', serviceCode: 'DEN-201', department: 'Dental', price: 3500 },

    { serviceName: 'Dental ΓÇö Scaling & Polishing', serviceCode: 'DEN-202', department: 'Dental', price: 1500 },

    { serviceName: 'Dental ΓÇö Tooth Extraction (Simple)', serviceCode: 'DEN-203', department: 'Dental', price: 1200 },

    { serviceName: 'Dental ΓÇö Ceramic Crown Replacement', serviceCode: 'DEN-204', department: 'Dental', price: 5000 },

    { serviceName: 'Dental ΓÇö Orthodontic Braces Consultation', serviceCode: 'DEN-205', department: 'Dental', price: 2500 },

    { serviceName: 'Physiotherapy ΓÇö Posture & Pain Rehab', serviceCode: 'PHY-301', department: 'Physiotherapy', price: 800 }
  ...
  // ΓöÇΓöÇΓöÇ Indent Tab State ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  const handleExportBillingCSV = () => {
    ...
    const rows = bills.map(bill => {
      ...
      const items = (bill.items || []).map(i => `${String(i.description || '')} (Γé╣${i.amount || 0})`).join('; ');

      const amount = `Γé╣${(bill.totalAmount || 0).toFixed(2)}`;
  ...
  const handleConfirmCoveragePharmacyPayment = async () => {
    ...
    try {
      ...
      showToast(`Payment of Γé╣${(selectedCoveragePharmacyRx.amountVal || 550).toFixed(2)} settled via ${coveragePharmacyPaymentMode}. Prescription dispensed successfully!`, 'success');
      ...
      {notification && (
        ...
        <div className="premium-toast" style={{
          ...
          <div style={{
            ...
            {notification.type === 'error' ? 'Γ£ò' : 'Γ£ô'}
            ...
            <div className="kpi-card-container semantic-card-info">
              ...
              <div className="modern-kpi-card semantic-card-info" onClick={() => switchTab('billing')}>
                ...
                <div>
                  ...
                  <div className="modern-kpi-val">Γé╣{filteredBills.filter(b => b.status === 'Paid').reduce((sum, b) => sum + (b.totalAmount || 0), 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
                                  ...
                                  {(() => {
                                    ...
                                    return (
                                      ...
                                      <div>
                                        ...
                                        <div style={{ fontSize: '12px', fontWeight: 800, color: '#1E293B' }}>Γé╣{Number(feeVal).toFixed(2)}</div>
                    ...
                    {(() => {
                      ...
                      bills.filter(b => {
                        ...
                        journeyEvents.push({
                          ...
                          title: `Invoice Settle - Γé╣${b.totalAmount?.toFixed(2)}`,
              ...
              <div onClick={() => setPrescriptionModalOpen(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,0.45)', backdropFilter: 'blur(4px)', zIndex: 9000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px' }}>
                ...
                <div onClick={e => e.stopPropagation()} style={{ background: 'white', borderRadius: '20px', padding: '32px', width: '100%', maxWidth: '600px', boxShadow: '0 24px 64px rgba(0,0,0,0.15)', animation: 'slideUp 0.3s ease-out' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                    ...
                    <button onClick={() => setPrescriptionModalOpen(false)} style={{ background: '#F1F5F9', border: 'none', borderRadius: '2px', width: '32px', height: '22px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', fontSize: '14px', fontWeight: 'bold' }}>Γ£ò</button>
              ...
              <div onClick={() => setAllLabsModalOpen(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,0.45)', backdropFilter: 'blur(4px)', zIndex: 9000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px' }}>
                ...
                <div onClick={e => e.stopPropagation()} style={{ background: 'white', borderRadius: '20px', padding: '32px', width: '100%', maxWidth: '700px', boxShadow: '0 24px 64px rgba(0,0,0,0.15)', animation: 'slideUp 0.3s ease-out', display: 'flex', flexDirection: 'column', maxHeight: '90vh' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexShrink: 0 }}>
                    ...
                    <button onClick={() => setAllLabsModalOpen(false)} style={{ background: '#F1F5F9', border: 'none', borderRadius: '2px', width: '32px', height: '22px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', fontSize: '14px', fontWeight: 'bold' }}>Γ£ò</button>
                          ...
                          >
                            ...
                            <div>
                              ...
                              <div style={{ fontSize: '13px', color: '#64748B', fontWeight: 600, marginTop: '4px' }}>
                                ...
                                #{p._id.substring(18).toUpperCase()} ΓÇó {p.gender} ΓÇó {p.age} Yrs
...
<div style={{ background: 'white', borderRadius: '12px', boxShadow: '0 10px 25px -5px rgba(0, 0, 0, 0.08), 0 8px 10px -6px rgba(0, 0, 0, 0.04)', display: 'flex', flexDirection: 'column', height: 'calc(100vh - 120px)', overflow: 'hidden', border: '1px solid #E2E8F0' }}>
                        ...
                        <div style={{ gridColumn: '1 / -1', display: 'flex', gap: '8px', flexWrap: 'wrap', minHeight: '24px', alignItems: 'center' }}>
                          ...
                          {selectedSymptoms.map(s => (
                            ...
                            <div key={s} style={{ background: '#F1F5F9', color: '#334155', padding: '4px 10px', fontSize: '11px', borderRadius: '12px', border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', gap: '6px', fontWeight: 500 }}>
                              ...
                              {s} <span onClick={() => !reschedulingAppointment && toggleSymptom(s)} style={{ cursor: 'pointer', color: '#94A3B8', fontWeight: 'bold' }}>├ù</span>
                      ...
                      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '24px' }}>
                        ...
                        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: 'minmax(200px, 1fr) minmax(200px, 1fr)', gap: '12px 24px' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <select className="impressive-select" style={{ height: '28px', fontSize: '12px', padding: '0 8px', border: '1px solid #CBD5E1', borderRadius: '4px', width: '120px', background: 'white' }}><option>INR (Γé╣)</option></select>
                        ...
                        {(() => {
                          ...
                          return (
                            ...
                            <div style={{ width: '280px', background: 'white', border: '1px solid #E2E8F0', borderRadius: '6px', padding: '12px', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#475569', marginBottom: '6px' }}><span>Gross Amount</span><span style={{ fontWeight: 600 }}>Γé╣{subtotalVal.toFixed(2)}</span></div>

                              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#EF4444', marginBottom: '8px' }}><span>Discount Amount</span><span style={{ fontWeight: 600 }}>-Γé╣{discAmt.toFixed(2)}</span></div>

                              <div style={{ borderTop: '1px dashed #CBD5E1', margin: '8px 0' }}></div>

                              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '16px', fontWeight: 900, color: '#0F172A', background: 'linear-gradient(135deg, #10B981 0%, #059669 100%)', padding: '8px 12px', borderRadius: '6px', color: 'white', margin: '-4px -8px' }}><span>Net Amount</span><span>Γé╣{finalTotalVal.toFixed(2)}</span></div>
                              ...
                              >
                                ...
                                <td style={{ paddingLeft: '24px' }}>
                                  ...
                                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#7C3AED', fontSize: '12px', fontWeight: 700 }}>
                                    ...
                                    <span style={{ fontSize: '14px', color: '#A78BFA' }}>Γå│</span>
              ...
              <div className="ph-kpi-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)', marginBottom: '12px' }}>
                  ...
                  <div className="kpi-card semantic-card-info" style={{ padding: '12px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '24px', fontWeight: 900 }}>Γé╣{bills.filter(b => b.status === 'Paid').reduce((sum, b) => sum + (b.totalAmount || 0), 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
                  ...
                  <div className="kpi-card semantic-card-warning" style={{ padding: '12px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '24px', fontWeight: 900 }}>Γé╣{bills.filter(b => b.status === 'Unpaid' || !b.status).reduce((sum, b) => sum + (b.totalAmount || 0), 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
                                ...
                                return sorted.map((bill, idx) => (
                                    ...
                                    <tr key={bill._id || idx}>
                                        ...
                                        <td style={{ fontWeight: 800 }}>
                                            ...
                                            <div>Γé╣{(bill.totalAmount || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>

                                            {bill.discountPercent > 0 && (

                                                <div style={{ fontSize: '10px', color: '#EF4444', fontWeight: 700, marginTop: '2px' }}>

                                                    ({bill.discountPercent}% off of Γé╣{(bill.originalAmount || (bill.totalAmount + bill.discountAmount)).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })})
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    ...
                    <thead>
                      ...
                      <tr style={{ background: '#F8FAFC' }}>
                        ...
                        <th style={{ padding: '14px 20px', fontSize: '12px', fontWeight: 800, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Indent ID Γåò</th>
                        ...
                        <th style={{ padding: '14px 20px', fontSize: '12px', fontWeight: 800, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Priority Γåò</th>

                        <th style={{ padding: '14px 20px', fontSize: '12px', fontWeight: 800, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Total Quantity Γåò</th>

                        <th style={{ padding: '14px 20px', fontSize: '12px', fontWeight: 800, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.5px', whiteSpace: 'nowrap' }}>Status Γåò</th>
                        ...
                        return (
                          ...
                          <tr key={itemKey} style={{ background: isSelected ? '#EFF6FF' : rowBg(ind.status), borderBottom: '1px solid rgba(241,245,249,0.8)', cursor: 'pointer' }}>
                            ...
                            <td onClick={e => e.stopPropagation()} style={{ padding: '14px 20px' }}>
                              ...
                              <div style={{ cursor: 'pointer', color: '#94A3B8', fontSize: '14px', letterSpacing: '2px', lineHeight: 1, userSelect: 'none' }} title="Actions">Γï«</div>
                              ...
                              filteredMeds.map(med => (
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <div style={{ fontSize: '11px', color: '#64748B', fontWeight: 600 }}>{med.category} ┬╖ SKU: {med.sku} ┬╖ MRP: Γé╣{med.mrp || 50}</div>
                                      ...
                                      {item.isCustom ? (
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center', width: '100%' }}>
                                                  ...
                                                  {filtered.map(med => (
                                                    ...
                                                    >
                                                      ...
                                                      <div>
                                                        ...
                                                        <div style={{ fontSize: '10px', color: '#64748B', fontWeight: 600, textAlign: 'left' }}>{med.category} ┬╖ MRP: Γé╣{med.mrp || 50}</div>
                                          ...
                                          <div style={{ display: 'flex', alignItems: 'center', gap: '2px', flexShrink: 0 }}>
                                            ...
                                            <span style={{ fontSize: '11px', fontWeight: 700, color: '#64748B' }}>Γé╣</span>
                                        ...
                                        <>
                                          ...
                                          <span style={{ fontSize: '11px', color: '#64748B', fontWeight: 600 }}>{item.unit} ┬╖ MRP: Γé╣{item.mrp}</span>
                  ...
                  <div style={{ border: '1px solid #E2E8F0', borderRadius: '16px', padding: '12px', background: '#F8FAFC', boxShadow: 'inset 0 1px 3px rgba(0,0,0,0.01)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                      ...
                      >
                        ...
                        Prescription {hasPrescriptionEnabled ? 'Γ£ô' : ''}
                      ...
                      >
                        ...
                        Lab Tests {hasLabOrderEnabled ? 'Γ£ô' : ''}
                  ...
                  <div style={{ marginTop: '24px', padding: '16px', borderRadius: '4px', background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '13px', color: '#64748B', fontWeight: 600 }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <span style={{ color: '#0F172A', fontWeight: 700 }}>Γé╣{(associatedBill.totalAmount || 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                      ...
                      {associatedBill.discountPercent > 0 && (
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', color: '#EF4444' }}>
                          ...
                          <span>-Γé╣{((associatedBill.originalAmount || associatedBill.totalAmount) - associatedBill.totalAmount).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
          ...
          <div className="details-modal-card" onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: '500px', padding: '28px', borderRadius: '16px', background: 'white' }}>
            ...
            <div style={{ background: '#F8FAFC', padding: '16px', borderRadius: '4px', marginBottom: '20px', border: '1px solid #E2E8F0' }}>
              ...
              <div style={{ borderTop: '1px solid #E2E8F0', paddingTop: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ fontSize: '14px', color: '#2563EB', fontWeight: 900 }}>Γé╣{(selectedCoveragePharmacyRx.amountVal || 550).toFixed(2)}</span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px' }}>
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <span style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', fontWeight: 800, color: '#475569', fontSize: '12px' }}>Γé╣</span>
                ...
                {coveragePharmacyCashReceived && Number(coveragePharmacyCashReceived) >= (selectedCoveragePharmacyRx.amountVal || 550) && (
                  ...
                  <div style={{ 
                    ...
                    <span>Γé╣{(Number(coveragePharmacyCashReceived) - (selectedCoveragePharmacyRx.amountVal || 550)).toFixed(2)}</span>
        ...
        <div className="details-modal-overlay" data-lenis-prevent onClick={() => { setShowPaymentModal(false); setPendingRegistrationPayload(null); }}>
          ...
          <div className="details-modal-card" onClick={e => e.stopPropagation()} style={{ maxWidth: '480px', padding: '12px' }}>
            ...
            <div className="details-modal-header" style={{ marginBottom: '20px', borderBottom: '1px solid #F1F5F9', paddingBottom: '12px' }}>
              ...
              <button className="details-modal-close" onClick={() => { setShowPaymentModal(false); setPendingRegistrationPayload(null); }}>Γ£ò</button>
            ...
            <form onSubmit={handleMarkAsPaidSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                ...
                <div>
                  ...
                  <input 
                    ...
                    value={`Γé╣${selectedBillForPayment.totalAmount.toLocaleString()}`} 
              ...
              <div style={{ backgroundColor: '#F8FAFC', borderRadius: '2px', padding: '16px', marginTop: '8px', display: 'flex', flexDirection: 'column', gap: '8px', border: '1px solid #E2E8F0' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', color: '#64748B', fontWeight: 600 }}>
                  ...
                  <span>Γé╣{selectedBillForPayment.totalAmount.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                ...
                {discountPercent > 0 && (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', color: '#EF4444', fontWeight: 600 }}>
                    ...
                    <span>-Γé╣{((selectedBillForPayment.totalAmount * discountPercent) / 100).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#0F172A', fontWeight: 850, borderTop: '1px dashed #CBD5E1', paddingTop: '8px', marginTop: '4px' }}>
                  ...
                  <span style={{ color: '#2563EB', fontSize: '17px' }}>Γé╣{(selectedBillForPayment.totalAmount - (selectedBillForPayment.totalAmount * discountPercent) / 100).toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
          ...
          <div onClick={() => { setShowIndentModal(false); setSelectedIndent(null); }} style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,0.45)', backdropFilter: 'blur(4px)', zIndex: 9000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px' }}>
            ...
            <div onClick={e => e.stopPropagation()} style={{ background: 'white', borderRadius: '20px', padding: '32px', width: '100%', maxWidth: '600px', boxShadow: '0 24px 64px rgba(0,0,0,0.15)', animation: 'slideUp 0.3s ease-out', display: 'flex', flexDirection: 'column', maxHeight: '90vh' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexShrink: 0 }}>
                ...
                <button onClick={() => { setShowIndentModal(false); setSelectedIndent(null); }} style={{ background: '#F1F5F9', border: 'none', borderRadius: '2px', width: '32px', height: '22px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', fontSize: '14px', fontWeight: 'bold' }}>Γ£ò</button>
          ...
          <div id="printable-receipt-slip" style={{ background: '#FFFFFF', borderRadius: '16px', width: '100%', maxWidth: '720px', padding: '36px 40px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', border: '1px solid #E2E8F0', position: 'relative', overflow: 'hidden' }}>
            ...
            >
              ...
              <div className="print-diagonal-watermark-subtext" style={{ fontSize: '22px', fontWeight: 800, color: '#64748B', letterSpacing: '12px', textTransform: 'uppercase', marginTop: '12px' }}>
                ...
                HEALTHCARE ΓÇó MEDICAL RECEIPT
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
                ...
                <thead>
                  ...
                  <tr style={{ background: '#F1F5F9', borderBottom: '1px solid #E2E8F0', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                    ...
                    <th style={{ padding: '10px 14px', textAlign: 'right', fontWeight: 800, color: '#475569', width: '120px' }}>Amount (Γé╣)</th>
                ...
                <tbody>
                  ...
                  {(activeSlipData.items || []).map((item, idx) => (
                    ...
                    <tr key={idx} style={{ borderBottom: '1px solid #F1F5F9', background: idx % 2 === 1 ? '#FAFAFA' : '#FFFFFF', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                      ...
                      <td style={{ padding: '10px 14px', textAlign: 'right', fontWeight: 800, color: '#0F172A' }}>Γé╣{(item.amount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</td>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#F0FDF4', border: '1.5px solid #BBF7D0', padding: '14px 18px', borderRadius: '2px', marginBottom: '20px', position: 'relative', zIndex: 1, WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ fontSize: '22px', fontWeight: 900, color: '#15803D', fontFamily: "'Outfit', sans-serif" }}>Γé╣{(activeSlipData.totalAmount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '12px', borderTop: '1px solid #E2E8F0', fontSize: '11px', color: '#64748B', fontWeight: 700, position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ fontSize: '10.5px', color: '#94A3B8', fontWeight: 600 }}>
                ...
                Official Computer Generated Receipt ΓÇó Valid Without Physical Signature
      ...
      {batchSmsSuccessToast && (
        ...
        <div style={{ position: 'fixed', bottom: '28px', right: '28px', background: '#0F172A', color: 'white', padding: '14px 20px', borderRadius: '4px', border: '1px solid #22C55E', boxShadow: '0 20px 40px rgba(0, 0, 0, 0.3)', display: 'flex', alignItems: 'center', gap: '12px', zIndex: 999999, animation: 'slideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1)' }}>
          ...
          <div style={{ width: '28px', height: '28px', borderRadius: '50%', background: '#22C55E', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: '12px' }}>Γ£ô</div>
        ...
        <div onClick={() => setLabModalOpen(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,0.45)', backdropFilter: 'blur(4px)', zIndex: 9000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px' }}>
          ...
          <div onClick={e => e.stopPropagation()} style={{ background: 'white', borderRadius: '20px', padding: '32px', width: '100%', maxWidth: '600px', boxShadow: '0 24px 64px rgba(0,0,0,0.15)', animation: 'slideUp 0.3s ease-out' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <button onClick={() => setLabModalOpen(false)} style={{ background: '#F1F5F9', border: 'none', borderRadius: '2px', width: '32px', height: '22px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', fontSize: '14px', fontWeight: 'bold' }}>Γ£ò</button>
