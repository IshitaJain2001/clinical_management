...
pattern = r'<div style=\{\{\s*border:\s*\'1px dashed #CBD5E1\'.*?Upload Document</button>'
...
if re.search(pattern, text, re.DOTALL):
    ...
    print('Failed. Trying broader search.')
    pattern2 = r'<div[^>]*>.*?<i data-lucide="camera".*?No Image Available.*?Upload Document</button>'
    # I'll just find No Image Available, go back to the previous div, and replace up to Upload Document
