...
start_block = text.rfind('<div', 0, idx - 50)
start_block = text.rfind('<div', 0, start_block)
start_block = text.rfind('<div style={{ flex: 1,', 0, idx) # find the container?

# Actually, let's just find the exact text using regex from `<div style={{ border: '1px dashed #CBD5E1'` 
...
if re.search(pattern, text, re.DOTALL):
    ...
    print('Failed to find old UI with new pattern.')
