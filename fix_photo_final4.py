...
# Find anchors
end_idx = text.find('Upload Document</button>') + len('Upload Document</button>')
# Look backwards for the start of the image div
start_text = "<div style={{ border: '1px dashed #CBD5E1'"
start_idx = text.rfind(start_text, 0, end_idx)
...
if start_idx != -1 and end_idx != -1:
    ...
    with open(main_file, 'w', encoding='utf-8') as f:
        f.write(text)
    print("SUCCESS! UI injected.")
else:
    print("Failed to find anchors.", start_idx, end_idx)
