...
router.get('/vitals/patient/:patientId', checkPatientConsent('treatment'), restrictEMRRole(['doctor', 'nurse', 'patient']), async (req, res) => {
  try {
...
// Record new vitals
router.post('/vitals', checkPatientConsent('treatment'), restrictEMRRole(['doctor', 'nurse']), async (req, res) => {
  try {
